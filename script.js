          ...
          body.innerHTML = `
            ...
            <div class="flex space-x-4 justify-center items-center">
              <button data-action="bat" class="group relative border-none cursor-pointer bg-black rounded-xl">
                <span
                  class="block box-border border-2 border-black rounded-xl px-6 py-3 bg-green-200 text-black font-bold text-[17px] transform translate-y-[-0.5] transition-transform duration-100 ease-in-out group-hover:-translate-y-0.5 group-active:translate-y-0">
                  Bat
                </span>
              </button>
              <button data-action="bowl" class="group relative border-none cursor-pointer bg-black rounded-xl">
                <span
                  class="block box-border border-2 border-black rounded-xl px-6 py-3 bg-blue-200 text-black font-bold text-[17px] transform translate-y-[-0.5] transition-transform duration-100 ease-in-out group-hover:-translate-y-0.5 group-active:translate-y-0">
                  Bowl
                </span>
              </button>
            </div>
  ...
  function declareResult() {
    ...
    body.innerHTML = `
      ...
      <button onclick="location.reload()" class="group relative border-none cursor-pointer bg-black rounded-xl mt-4">
        <span
          class="block box-border border-2 border-black rounded-xl px-6 py-3 bg-purple-200 text-black font-bold text-[17px] transform translate-y-[-0.5] transition-transform duration-100 ease-in-out group-hover:-translate-y-0.5 group-active:translate-y-0">
          Play Again
        </span>
      </button>
    `;
